...
public class Product {
    ...
    @Expose
    private List<Object> categoryPath = null;
    @SerializedName("category_path_ids")
    @Expose
    private List<Object> categoryPathIds = null;
    ...
    @Expose
    private List<Object> taxonomyPath = null;
    ...
    public List<Object> getCategoryPathIds() {
        return categoryPathIds;
    }

    public void setCategoryPathIds(List<Object> categoryPathIds) {
    ...
    public List<Object> getTaxonomyPath() {
        return taxonomyPath;
    }

    public void setTaxonomyPath(List<Object> taxonomyPath) {
